...
public class MainActivity extends Activity implements SensorEventListener {
	...
	private Bluetooth mBluetooth = new Bluetooth();
...
//        mTextAccel = (TextView)findViewById(R.id.textAccel);
//        mColorWheelView.setImageBitmap(mColorWheel);
        mBluetooth.init(this);
    }
    ...
    public boolean onPrepareOptionsMenu (Menu menu) {
    	...
    	List<String> devices = mBluetooth.scan();
    ...
    public void onSensorChanged(SensorEvent event) {
    	if (mTextAccel != null) mTextAccel.setText("Angle is " + String.format("%.2f", Math.atan(event.values[1] / event.values[0])));
    }
